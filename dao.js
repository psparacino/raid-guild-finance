...
const variables = {
  address: "0xfe1084bc16427e5ehb7f13fc19bcd4e641f7d571f",
  skip: 0
};
...
// const balanceObjects = balances.map(balance => {
//     let id;
//     let match;
...
processBalances().then((data) => console.log(data));
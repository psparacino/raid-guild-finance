...
function dateToHasuraFormat(values) {
...
export async function getCurrentTokenPrice(balances) {
  ...
  // const result = await dateToHasuraFormat(values);
...
//   "query": "mutation { insert_treasury_token_history(objects: {token_name: \"testToken\", date: \"2023-01-07\", price_usd: \"9999\"}) { affected_rows } }"
